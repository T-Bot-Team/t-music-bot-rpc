...
## Corpus Check
- 53 files · ~110,417 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 485 nodes · 646 edges · 45 communities (36 shown, 9 thin omitted)
...
## Knowledge Gaps
- **166 isolated node(s):** `code`, `userId`, `sessionToken`, `298432708269441034`, `1504684558065471506` (+161 more)

...
## Corpus Check
- 46 files · ~113,745 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 608 nodes · 791 edges · 51 communities (41 shown, 10 thin omitted)
...
## Knowledge Gaps
- **234 isolated node(s):** `code`, `userId`, `sessionToken`, `298432708269441034`, `1504684558065471506` (+229 more)

...
## Corpus Check
- 46 files · ~112,853 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 555 nodes · 718 edges · 50 communities (40 shown, 10 thin omitted)
...
## Knowledge Gaps
- **206 isolated node(s):** `code`, `userId`, `sessionToken`, `1504684558065471506`, `298432708269441034` (+201 more)

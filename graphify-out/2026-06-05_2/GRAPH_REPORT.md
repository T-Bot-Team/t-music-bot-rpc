# Graph Report - t-music-bot-rpc-rust  (2026-06-05)

## Corpus Check
- 46 files · ~113,763 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 599 nodes · 781 edges · 51 communities (41 shown, 10 thin omitted)
...
Cohesion: 0.09
Nodes (28): workflows/release.yml, Build Steps, Building from Source, code:bash (git clone https://github.com/TehPig/t-music-bot-rpc.git), code:bash (cargo check), code:bash (cargo build --release), Command Line Options, Configuration Guide (+20 more)
...
Cohesion: 0.05
Nodes (40): 1. Using Voicemeeter Mixer (Windows-only), 1. Windows: Using Voicemeeter Mixer, 2. macOS: Using BlackHole Loopback, 2. Using VB-Audio Virtual Cable (Windows / macOS), 2. Using VB-Audio Virtual Cable (Windows / macOS - Mixerless Setup), Audio Routing & Isolation Guide, Bus and Device Mappings, Choosing Your Version (+32 more)

### Community 48 - "Community 48"
Cohesion: 0.29
Nodes (6): 1. Top Panel: Real-Time Connection Status, 2. Core Setup: Discord Pairing, 3. Visualizer Settings Card, 4. Visual Styling & Color Shuffling, 5. Overlay Layout Configurations, Web Dashboard & Settings Tour

### Community 49 - "Community 49"
Cohesion: 0.33
Nodes (5): 1. Core Metrics Benchmark Summary, 2. Architectural Comparison, Architectural & Performance Comparison: TS vs. Rust, Legacy TypeScript (Node.js) Setup, Native Rust Setup

### Community 50 - "Community 50"
Cohesion: 0.41
Nodes (12): 3. Linux: Using PipeWire / PulseAudio Virtual Sinks, code:bash (pactl load-module module-null-sink sink_name=visualizer_sink), code:bash (pactl load-module module-loopback source=visualizer_sink.mon), Configuration Steps, Configuration Steps, Configuration Steps, Configuration Steps, Configuration Steps (+4 more)

## Knowledge Gaps
- **227 isolated node(s):** `code`, `userId`, `sessionToken`, `298432708269441034`, `1504684558065471506` (+222 more)
...
- **Why does `Table of Contents` connect `Community 47` to `Community 50`?**

...
## Summary
- 595 nodes · 775 edges · 51 communities (41 shown, 10 thin omitted)
...
Cohesion: 0.07
Nodes (40): 1. Using Voicemeeter Mixer (Windows-only), 1. Windows: Using Voicemeeter Mixer, 2. macOS: Using BlackHole Loopback, 2. Using VB-Audio Virtual Cable (Windows / macOS), 3. Linux: Using PipeWire / PulseAudio Virtual Sinks, Audio Routing & Isolation Guide, Bus and Device Mappings, Choosing Your Version (+32 more)
...
## Knowledge Gaps
- **225 isolated node(s):** `code`, `userId`, `sessionToken`, `1504684558065471506`, `298432708269441034` (+220 more)

# Graph Report - t-music-bot-rpc-rust  (2026-06-01)

## Corpus Check
- 46 files · ~112,774 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 555 nodes · 717 edges · 50 communities (40 shown, 10 thin omitted)
...
## Knowledge Gaps
- **206 isolated node(s):** `code`, `userId`, `sessionToken`, `298432708269441034`, `1504684558065471506` (+201 more)

...
## Corpus Check
- 45 files · ~112,223 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 549 nodes · 712 edges · 49 communities (39 shown, 10 thin omitted)
...
## Knowledge Gaps
- **203 isolated node(s):** `code`, `userId`, `sessionToken`, `298432708269441034`, `1504684558065471506` (+198 more)

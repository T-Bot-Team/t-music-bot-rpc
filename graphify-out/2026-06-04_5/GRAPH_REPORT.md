...
## Corpus Check
- 46 files · ~113,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 584 nodes · 755 edges · 50 communities (40 shown, 10 thin omitted)
...
Cohesion: 0.06
Nodes (37): 1. Using Voicemeeter Mixer (Windows-only), 1. Windows: Using Voicemeeter Mixer, 2. macOS: Using BlackHole Loopback, 2. Using VB-Audio Virtual Cable (Windows / macOS), 3. Linux: Using PipeWire / PulseAudio Virtual Sinks, Audio Routing & Isolation Guide, Bus and Device Mappings, Choosing Your Version (+29 more)
...
## Knowledge Gaps
- **219 isolated node(s):** `code`, `userId`, `sessionToken`, `1504684558065471506`, `298432708269441034` (+214 more)

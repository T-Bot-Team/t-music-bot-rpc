...
## Corpus Check
- 46 files · ~113,033 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 568 nodes · 731 edges · 50 communities (40 shown, 10 thin omitted)
...
Cohesion: 0.09
Nodes (21): 1. Windows: Using Voicemeeter Mixer, 2. macOS: Using BlackHole Loopback, 3. Linux: Using PipeWire / PulseAudio Virtual Sinks, Audio Routing & Isolation Guide, Choosing Your Version, code:bash (pactl load-module module-null-sink sink_name=visualizer_sink), code:bash (pactl load-module module-loopback source=visualizer_sink.mon), Installing the Software (+13 more)
...
## Knowledge Gaps
- **214 isolated node(s):** `code`, `userId`, `sessionToken`, `1504684558065471506`, `298432708269441034` (+209 more)

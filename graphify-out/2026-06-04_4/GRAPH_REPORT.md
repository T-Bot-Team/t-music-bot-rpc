...
## Corpus Check
- 46 files · ~113,329 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 581 nodes · 750 edges · 50 communities (40 shown, 10 thin omitted)
...
Cohesion: 0.07
Nodes (34): 1. Using Voicemeeter Mixer (Windows-only), 1. Windows: Using Voicemeeter Mixer, 2. macOS: Using BlackHole Loopback, 2. Using VB-Audio Virtual Cable (Windows / macOS), 3. Linux: Using PipeWire / PulseAudio Virtual Sinks, Audio Routing & Isolation Guide, Choosing Your Version, code:bash (pactl load-module module-null-sink sink_name=visualizer_sink) (+26 more)
...
## Knowledge Gaps
- **217 isolated node(s):** `code`, `userId`, `sessionToken`, `1504684558065471506`, `298432708269441034` (+212 more)

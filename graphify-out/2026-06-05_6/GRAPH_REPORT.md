...
## Corpus Check
- 51 files · ~115,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 654 nodes · 832 edges · 56 communities (46 shown, 10 thin omitted)
...
## Knowledge Gaps
- **256 isolated node(s):** `code`, `userId`, `sessionToken`, `1504684558065471506`, `298432708269441034` (+251 more)
